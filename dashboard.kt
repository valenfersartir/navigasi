...
import com.example.belajar_navigation.databinding.FragmentHalamanProfil2Binding
...
//    }
    ...
    override fun onCreateView(
       ...
       binding.btnprofil.setOnClickListener{
           it.findNavController(R.id.action_dashboard_to_halamanProfil2)
        }
        ...
        binding.btndiklat.setOnClickListener{
            it.findNavController(R.id.action_dashboard_to_halamanDiklat)
        }
        return binding.root
    }
}
